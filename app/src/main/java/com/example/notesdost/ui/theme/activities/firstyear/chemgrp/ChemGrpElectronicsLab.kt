...
class ChemGrpElectronicsLab : AppCompatActivity() {
        ...
        popupMenu.setOnMenuItemClickListener { menuItem ->
            when (menuItem.itemId) {
                R.id.privacy -> {
                    ...
                    val intent = Intent(this@ChemGrpElectronicsLab, Privacy::class.java)
                ...
                R.id.quiz -> {
                    // Open Quiz Activity
                    val intent = Intent(this@ChemGrpElectronicsLab, Quiz::class.java)
                    startActivity(intent)
                    true
                }
                else -> false
    ...
    private fun addData() {
        ...
        topicsList.add(Topics("Electronics Lab PDF", "https://drive.google.com/file/d/1n7NCEWQmpP3-19rVLGOF4gNSJzbmHqFR/view?usp=drive_link_link"))
        chapterList.add(Chapter("Electronics Lab", topicsList))
