        ...
        popupMenu.setOnMenuItemClickListener { menuItem ->
            when (menuItem.itemId) {
                R.id.privacy -> {
                    ...
                    val intent = Intent(this@PhyGrpPhyLab, Privacy::class.java)
                    startActivity(intent)
                    true
                }
                R.id.about -> {
                    // Open About Activity
                    val intent = Intent(this@PhyGrpPhyLab, About::class.java)
                    startActivity(intent)
                    true
                }
                R.id.feedback -> {
                ...
                R.id.quiz -> {
                    // Open Quiz Activity
                    val intent = Intent(this@PhyGrpPhyLab, Quiz::class.java)
                    startActivity(intent)
                    true
                }
                else -> false
