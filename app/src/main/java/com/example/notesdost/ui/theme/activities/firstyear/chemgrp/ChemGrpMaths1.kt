...
class ChemGrpMaths1 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_chem_grp_maths1)
        ...
        popupMenu.setOnMenuItemClickListener { menuItem ->
            when (menuItem.itemId) {
                R.id.privacy -> {
                    ...
                    val intent = Intent(this@ChemGrpMaths1, Privacy::class.java)
                    startActivity(intent)
                    true
                }
                R.id.about -> {
                    // Open About Activity
                    val intent = Intent(this@ChemGrpMaths1, About::class.java)
                    startActivity(intent)
                    true
                }
                R.id.feedback -> {
                ...
                R.id.quiz -> {
                    // Open Quiz Activity
                    val intent = Intent(this@ChemGrpMaths1, Quiz::class.java)
                    startActivity(intent)
                    true
                }
                else -> false
