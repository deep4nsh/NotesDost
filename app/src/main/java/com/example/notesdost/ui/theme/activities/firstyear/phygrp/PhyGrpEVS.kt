...
class PhyGrpEVS : AppCompatActivity() {
        ...
        popupMenu.setOnMenuItemClickListener { menuItem ->
            when (menuItem.itemId) {
                R.id.privacy -> {
                    ...
                    val intent = Intent(this@PhyGrpEVS, Privacy::class.java)
                    startActivity(intent)
                    true
                }
                R.id.about -> {
                    // Open About Activity
                    val intent = Intent(this@PhyGrpEVS, About::class.java)
                    startActivity(intent)
                    true
                }
                R.id.feedback -> {
                ...
                R.id.quiz -> {
                    // Open Quiz Activity
                    val intent = Intent(this@PhyGrpEVS, Quiz::class.java)
                    startActivity(intent)
                    true
                }
                else -> false
